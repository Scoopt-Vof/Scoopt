...
adapters in README-LIVE-APIS.md — it enriches products those feeds already
created, it doesn't add new ones.

Flow this enables: a shopper searches for or is shown a suggested product,
sees it with a real manufacturer photo instead of a placeholder, and clicks
through to the existing price comparison (unchanged — still eBay etc.).
